...
\begin{table}[htbp]
    ...
    \hline
    10 & Be able to directly open a document from the search in MonkeyPuzzle & Won't\\
    \hline
    \end{tabular}
    \caption{MoSCoW}
    \label{table:1}
...
\subsubsection{Waterfall Methodology in relation to the Project}
